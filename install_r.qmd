...
In order to make PDFs on your mac, you will need to install HomeBrew and then install the MacTex distribution. You can do that by running the following commands in your Terminal app. Keep in mind you may be asked for your password at several points throughout the process.
...
Pay attention at the end of the HomeBrew installation; you will be asked to copy and paste some lines into your terminal. *If you do not do this, HomeBrew will not work!*

#### Install MacTex

Only run this portion AFTER you have run MacTex.
