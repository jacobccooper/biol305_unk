...
In order to make `pdf` documents, you will need to have a `tinytex` distribution installed. You can do this with the following commands in the console (bottom left) window.
