...
author: "Dr. Jacob C. Cooper and Caleb Rother"
format: html
editor: visual
---
...
However, the library *DescTools* has many missing basic statistical functions, including **Mode()**. Use this method in your codeto reduce clutter and make the code run faster.

```{r}
# Install package (remove the hashtag to perform this)
