...
**The following is not required for calculating kurtosis, and this is an example to show something more kurtic.**

Let's compare these to a more kurtic distribution:
...
<summary>Click to see how to make a cumulative frequency plot if data are a numeric vector</summary>
...
<summary>Click to see how to make a cumulative frequency plot if data are in count format</summary>
...
5.  Create a boxplot of these data. Are there any outliers in this dataset?
6.  Compare the methods used to examine the data above. How do these methods help you understand the data? Do the numerical results from parts like skewness and kurtosis make sense with your plots?
...
1.  Create a histogram of these data.
2.  Create a cumulative frequency plot of these data.
3.  Calculate the kurtosis of these data, and make a conclusion about the kurtosis.
4.  Calculate the skewness of these data, and make a conclusion about the skewness.
5.  Create a boxplot of these data. Are there any outliers?
