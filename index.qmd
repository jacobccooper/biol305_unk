...
This site will help you navigate different homework assignments to perform the necessary *R* tests. Furthermore, this GitHub repository contains most of the homework dataframes, so you will *not* have to manually enter assignments if you use *R* to complete some of your assignments.
...
Original lecture organizer, author of many of the example problems.

-   [Dr. Jacob C. Cooper](https://scholar.google.com/citations?user=Q82K8tsAAAAJ)

Original website designer, primary R coding for site
