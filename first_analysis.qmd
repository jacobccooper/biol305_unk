...
In this class, there is one major library that you will need *almost every week*! **Even if I don't declare these libraries, you should load them in your documents**.
...
2.  `UNKstats`: this package was specifically designed for this class, and includes many helper functions for calculating specific statistics.
...
# UNKstats is very useful for this course!
# many important plotting and descriptive functions
...
**NOTE: The following is required in EVERY DOCUMENT that uses the `tidyverse` or `UNKstats` commands!**
