...
**NOTE**: Don't forget to write down your *t*-values, *df*, and *p* values in your answer. Your full sentence conclusion should relate back to the original hypothesis.

This is a minimal document to guide you; data other than *p* have been omitted to not bias you on your approaches.
...
The test is significant ($p = 0.001$).

The test statistic is -4.03.
...
The test is not significant ($p = 0.20$).

The test statistic is -1.32.
...
The test is not significant ($p = 0.06$).
...
wilcox.test(virginica$Petal.Width, versicolor$Petal.Width, alternative = "two.sided")
```

The test is significant ($p < 0.0001$).

The test statistic is 49 *or* 2451.
